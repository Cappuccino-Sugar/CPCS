...
#     args.gpu = gpu
    ...
    # creat memorybank
    memory_bank_base = MemoryBank(len(cluster_dataset),
    ...
    # clu_index_clu, index_NN_clu, ACC = find_cluste_center(dataclu_clu, model, memory_bank_base,
    #                                               class_num, args)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        clu_index_clu, index_NN_clu, acc1 = find_cluste_center(dataclu_clu, model, memory_bank_base,
                                                         class_num, args)
        # print(clu_index_clu)
        # print("=> Initializing cluster center index")
        # if bestACC < ACC:
