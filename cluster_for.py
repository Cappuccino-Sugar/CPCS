...
def main_worker(gpu, ngpus_per_node, args):
    ...
    writeFile(data_acc, data_nmi, data_ari, 'result/{}/{}'.format(args.dataset, 'eval500_20'))
...
def validate(val_loader, model, args):
    ...
    for i, (images, target) in enumerate(val_loader):
        ...
        # compute output
        with torch.no_grad():
            output = model.module.forward_cluster(images)
...
def writeFile(data_acc, data_nmi, data_ari, filename):
    """
